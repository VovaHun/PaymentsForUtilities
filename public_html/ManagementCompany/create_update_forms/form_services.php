		...
		<div class="container content">
			<div class="main__left">
				<div class="container">
					...
					<form class="" method="post" action="/ManagementCompany/create_update_query/update_query_services.php">
									...
									<tr> 
										...
										<td><select class="select_contractor select_db" name="contractor">
											<?php
											    ...
											    mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);
												$query1= "SELECT Contractors.СontractorId, Contractors.Name 
												FROM Contractors 
												LEFT JOIN ManagementCompany AS ManagementCompany ON (ManagementCompany.RegionId =  Contractors.RegionId ) 
									...
									<tr> 
										...
										<td><select class='select_db' name="company">
											<?php
											    echo "<option value = 'NULL'>&nbsp;</option>";
											    mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);
												$query2= "SELECT ManagementCompany.CompanyId, ManagementCompany.Name FROM ManagementCompany WHERE ManagementCompany.CompanyId = ".$company_admin['CompanyId'];
										...
										<td>
											<select class="select_mainserv select_db" name="mainServ">
												<?php 
													...
													{
													    $query3= "SELECT Services.ServiceId, Services.Name FROM Services WHERE Services.ServiceId != ".$res." AND Services.СontractorId = ".$selectedContractor." AND Services.CompanyId = ".$company_admin['CompanyId']." ORDER BY Services.Name";
						    ...
						    <table width='100%'>
								<tr>
									<td>
										...
										<?php 
                    						echo "<a href='/ManagementCompany/?table=Services'>Отменить</a>";
                    					?>
									</td>
								</tr>
								<?php
	...
	$(document).ready(function(){  
        ...
        $('#check').click(function(){
	        if($("#check").prop("checked")){
	            ...
	            $.ajax({
	                method: "POST",
	                url: "/ManagementCompany/create_update_forms/services_query.php",
