		...
		<div class="container content">
			<div class="main__left">
					...
					<div class="container">
						...
						<form class="" method="post" action="/ManagementCompany/create_update_query/update_query.php">
							<input type="hidden" name="elem_id" value='<?php echo $res?>'>
							<div class="form_wrapper">
								<table>
									<?php
										$query2 ="SELECT * FROM Regions, ManagementCompany WHERE Regions.RegionId = ManagementCompany.RegionId 
											AND ManagementCompany.CompanyId = ".$company_admin['CompanyId']."
							...
							<div>
								...
								<tr>
									<td>
										...
										<a href="/ManagementCompany/?table=Contractors">Отменить</a>
									</td>
								</tr>
								<?php
									if ( $res != -1 ) {
