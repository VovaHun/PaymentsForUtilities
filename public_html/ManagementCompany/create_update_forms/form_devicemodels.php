		...
		<div class="container content">
			<div class="main__left">
					...
					<div class="container">
						...
						<form class="" method="post" action="/ManagementCompany/create_update_query/update_query_devicemodels.php">
							...
							<tr> 
								<td><label>Межповерочный интервал, мес: </label> </td>
									<td>
										...
										if($res == -1)
											{ 
												echo "<input type=text pattern='^[ 0-9]+$' name=dateInt value='' required>";  
    										}
    									else
    										{
    											echo "<input type=text pattern='^[ 0-9]+$' name=dateInt value='".$row1['CheckInterval']."' required>";  
    										}
							...
							<div>
								...
								<tr>
									<td>
										...
										<?php 
            								echo "<a href='/ManagementCompany/?table=DeviceModels'>Отменить</a>";
            							?>
									</td>
								</tr>
								<?php
