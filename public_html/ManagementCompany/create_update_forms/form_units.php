			...
			<div class = "container content">
				<div class = "main__left">
					...
					<div class = "container">
						...
						<form class = "" method = "post" action = "/ManagementCompany/create_update_query/update_query_units.php">
							...
							<div>
								...
								<tr>
									<td>
										...
										<?php 
            								echo "<a href = '/ManagementCompany/?table=Units'>Отменить</a>";
            							?>
									</td>
								</tr>
								<?php
							...
							<input type = "hidden" name = "elem_table" value = "Units">
						</form>
					</div>
				</div>
			</div>
