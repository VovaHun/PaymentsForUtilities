		...
		<?php
			...
			if($res != -1)
			{
			    $query1 = "SELECT 
					...
					WHERE PersonalAccounts.AccountId = '".$res."' AND ManagementCompany.CompanyId = '".$company_admin['CompanyId']."'";
			...
			<div class = "container content">
				<div class = "main__left">
					<div class = "container">
						...
						<form class = "" method = "post" action = "/ManagementCompany/create_update_query/update_query_personalaccount.php">
											...
											<td>
												<select name = "regionId" class = "select_region select_db" required>
													...
													<?php
														...
														$query = "SELECT Regions.RegionId, Regions.RegionСode, Regions.Name FROM Regions, ManagementCompany WHERE Regions.RegionId = ManagementCompany.RegionId AND ManagementCompany.CompanyId = '".$company_admin['CompanyId']."' ";
										...
										<tr>
											...
											<td>
												<select name = "companyId" class = "select_company select_db" required>
													...
													<?php
													    echo "<option value = 'NULL'>Не указано</option>";
														$query = "SELECT * FROM ManagementCompany WHERE ManagementCompany.CompanyId = '".$company_admin['CompanyId']."' ";
														$result_sel = mysqli_query($link, $query);
								...
								<table width = '100%'>
									<tr>
										<td>
											...
											<?php 
												echo "<a href = '/ManagementCompany/index.php?table=PersonalAccounts'>Отменить</a>";
											?>
										</td>
									</tr>
									<?php
