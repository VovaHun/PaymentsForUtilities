		...
		<div class="container content">
			<div class="main__left">
					...
					<div class="container">
						...
						<form class="" method="post" action="/ManagementCompany/create_update_query/update_query_accountdevices.php">
							...
							<div class="form_wrapper">
								<table>
									<?php
										$query1 ="SELECT PersonalAccounts.AccountId, PersonalAccounts.Name, PersonalAccounts.CompanyId 
											FROM PersonalAccounts WHERE PersonalAccounts.CompanyId = ".$company_admin['CompanyId']."
											ORDER BY PersonalAccounts.Name";
										$result1 = mysqli_query($link, $query1) or die("Ошибка " . mysqli_error($link));

										$query2 ="SELECT Services.ServiceId, Services.Name, ManagementCompany.Name, Services.CompanyId
									          FROM Services 
										...
										$query4 ="SELECT Devices.DeviceId, Devices.Name, Devices.CompanyId FROM Devices 
										...
										if ($accountId != -1){
											$query0 ="SELECT AccountDevices.AccountId, AccountDevices.ServiceId, AccountDevices.TariffId, AccountDevices.DeviceId, AccountDevices.Date, AccountDevices.Using
                      							FROM AccountDevices WHERE AccountDevices.AccountId = ".$accountId." AND AccountDevices.ServiceId=".$serviceId." AND AccountDevices.TariffId=".$tariffId." AND AccountDevices.DeviceId=".$deviceId;
							...
							<div>
								...
								<tr>
									<td>
										...
										<a href="/ManagementCompany/?table=AccountDevices">Отменить</a>
									</td>
								</tr>
								<?php
									if ( $accountId != -1 ) {
