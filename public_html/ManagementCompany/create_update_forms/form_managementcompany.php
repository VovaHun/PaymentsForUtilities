		...
		<div class = "container content">
			<div class = "main__left">
				<div class = "container">
					...
					<form class = "" method = "post" action = "/ManagementCompany/create_update_query/update_query_managmentcompany.php">
						<input type = "hidden" name = "elem_id" value = '<?php echo $res?>'>
						<div class = "form_wrapper">
							<table>
								<?php
									$query2  = "SELECT * FROM Regions, ManagementCompany WHERE Regions.RegionId = ManagementCompany.RegionId AND ManagementCompany.CompanyId = '".$company_admin['CompanyId']."' ORDER BY Regions.RegionСode";
									...
									while($row1 = mysqli_fetch_array($result1))
									{
										...
										echo "<tr>";
											...
											echo "<td>";
											echo "<select disabled class='select_db' name='fn[]'>";
							...
							<table width='100%'>
								<tr>
									<td>
										...
										<a href = "/ManagementCompany/?table=ManagementCompany">Отменить</a>
									</td>
								</tr>
							</table>
						</div>
