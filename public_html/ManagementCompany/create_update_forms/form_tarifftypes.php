			...
			<div class = "container content">
				<div class = "main__left">
					...
					<div class = "container">
						...
						<form class = "" method = "post" action = "/ManagementCompany/create_update_query/update_query_tarifftypes.php">
										...
										<tr>
											...
											<td>
												<?php  
													...
													{
														echo "<input disabled type = text name = name value = '$row[1]' required>";
													}
												?>
											</td>
										</tr>
								...
								<tr>
									<td>
										<?php 
            								...
            								echo "<a href = '/ManagementCompany/?table=TariffTypes'>Отменить</a>";
            							?>
									</td>
								</tr>
								<?php
