    ...
    <table id="data_table">
    	...
    	<?php
            ...
            if ( isset( $_GET[ 'ServiceId' ] ) ) {
    			$where = $where . ( empty( $where ) ? "WHERE " : " AND " ) . "( ModelFunctions.ServiceId = " . $_GET[ 'ServiceId' ] . " )";
    		}
    		
    		if ( isset( $_GET[ 'ModelId' ] ) ) {
    			$where = $where . ( empty( $where ) ? "WHERE " : " AND " ) . "( ModelFunctions.ModelId = " . $_GET[ 'ModelId' ] . " )";
    		}
    		...
    		$query1 ="SELECT 
                      ...
                      LEFT JOIN Tariffs AS Tariffs ON (Tariffs.TariffId = ModelFunctions.TariffId)
                      " . $where . "
