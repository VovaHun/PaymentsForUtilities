<?php
  ...
  $query= "SELECT Services.ServiceId, Services.Name FROM Services WHERE Services.ServiceId != ".$ServiceId." AND Services.СontractorId = ".$ContractorId." ORDER BY Services.Name";
