<?php
    ...
    if ( $QueryId == -1 ) {
		$query = "INSERT INTO UsersQuery ( Login, Password, Name, Gender, Email, EmailNotifications, Phone, PhoneNotifications, AppealType, Appeal, Comment, ConsentOnPersonalData, BotId, SocialId, SocialNotifications, QueryDate ) 
				  VALUES ( '" . $Login. "', '" . password_hash( $Password, PASSWORD_DEFAULT ) . "', '" . $Name . "', " . $Gender . ", '" . $Email . "', " . $EmailNotificationsmai . ", '" . $Phone . "', " . $PhoneNotifications . ", " . $AppealType . ", '" . $Appeal . "', '" . $Comment . "', " . $ConsentOnPersonalData . ", " . $BotId . ", " . $SocialId . ", " . $SocialNotifications . ", " . $QueryDate . " )";
	}
	else{
		$query = "UPDATE UsersQuery 
		          SET Login = '" . $Login . "', Password = '" . $Password . "', Name = '" . $Name . "', Gender = " . $Gender . ", Email = '" . $Email . "', EmailNotifications = " . $EmailNotifications . ", Phone = '" . $Phone . "', PhoneNotifications = " . $PhoneNotifications . ", AppealType = " . $AppealType . ", Appeal = '" . $Appeal . "', Comment = '" . $Comment . "', ConsentOnPersonalData = " . $ConsentOnPersonalData . ", BotId = " . $BotId . ", SocialId = " . $SocialId . ", SocialNotifications = " . $SocialNotifications . ", QueryDate = " . QueryDate . " 
				  WHERE ( QueryId = " . $QueryId . " )";
	}

	$result = mysqli_query( $link, $query ) or die( "Ошибка: " . mysqli_error( $link ) );

	header( "Location: ../index.php?table=UsersQuery" );
?>