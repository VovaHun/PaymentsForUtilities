<?php
    ...
    if ( $UserId == -1 ) {
		$query = "INSERT INTO Users ( Login, Password, Name, Gender, Email, EmailNotifications, Phone, PhoneNotifications, AppealType, Appeal, Comment, ConsentOnPersonalData, BotId, SocialId, SocialNotifications, RegistrationDate ) 
				  VALUES ( '" . $Login. "', '" . password_hash( $Password, PASSWORD_DEFAULT ) . "', '" . $Name . "', " . $Gender . ", '" . $Email . "', " . $EmailNotificationsmai . ", '" . $Phone . "', " . $PhoneNotifications . ", " . $AppealType . ", '" . $Appeal . "', '" . $Comment . "', " . $ConsentOnPersonalData . ", " . $BotId . ", " . $SocialId . ", " . $SocialNotifications . ", " . $RegistrationDate . " )";
	}
	else{	
		$query = "UPDATE Users 
