    ...
    <table id="data_table">
    	<?php
			...
			if ( isset( $_GET[ 'CompanyId' ] ) ) {
				$where = ( empty( $where ) ? "WHERE " : " AND " ) . "( Objects.CompanyId = " . $_GET[ 'CompanyId' ] . " )";
			}
		...
		<?php
			if ( isset( $data ) ) {
				...
				foreach ( $data as $value ) {
					...
					echo "<td width='20px'><a href='#ex1' onclick=\"Delete('Objects', " . $value . ")\" rel='modal:open'><img src='../images/Delete.png' alt='Удалить запись'></a></td>";
					echo "</tr>";
