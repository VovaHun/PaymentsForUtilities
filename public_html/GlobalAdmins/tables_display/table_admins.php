		...
		<tbody>
			...
			<?php
    			...
    			if ( isset( $_GET[ 'CompanyId' ] ) ) {
    				$where = ( empty( $where ) ? "WHERE " : " AND " ) . "( Admins.CompanyId = " . $_GET[ 'CompanyId' ] . " )";
    			}
		...
		<?php
			if ( isset( $data ) ) {
				...
				foreach ( $data as $value ) {
					...
					echo "<td width = '20px'><a href = '#ex1' onclick=\"Delete('Admins', " . $value . ")\" rel = 'modal:open'><img src = '../images/Delete.png' alt = 'Удалить запись'></a></td>";
					echo "</tr>";
