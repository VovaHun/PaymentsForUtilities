	...
	<?php
	    $where = "";
			...
			if ( isset( $_GET[ 'СontractorId' ] ) ) {
				$where = ( empty( $where ) ? "WHERE " : " AND " ) . "( Services.СontractorId = " . $_GET[ 'СontractorId' ] . " )";
			}
			
			if ( isset( $_GET[ 'CompanyId' ] ) ) {
				$where = ( empty( $where ) ? "WHERE " : " AND " ) . "( Services.CompanyId = " . $_GET[ 'CompanyId' ] . " )";
			}
			
			if ( isset( $_GET[ 'MainServiceId' ] ) ) {
				$where = ( empty( $where ) ? "WHERE " : " AND " ) . "( Services.MainServiceId = " . $_GET[ 'MainServiceId' ] . " )";
			}
