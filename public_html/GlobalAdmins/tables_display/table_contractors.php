    ...
    <table id="data_table">
    	...
    	<?php
			...
			if ( isset( $_GET[ 'RegionId' ] ) ) {
				$where = ( empty( $where ) ? "WHERE " : " AND " ) . "( Contractors.RegionId = " . $_GET[ 'RegionId' ] . " )";
			}
		...
		<?php
			if ( isset( $data ) ) {
				...
				foreach ( $data as $value ) {
					...
					echo "<td width='20px'><a href='#ex1' onclick=\"Delete('Contractors', " . $value . ")\" rel='modal:open'><img src='../images/Delete.png' alt='Удалить запись'></a></td>";
					echo "</tr>";
