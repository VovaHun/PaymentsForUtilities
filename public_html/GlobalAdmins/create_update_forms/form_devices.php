		...
		<div class="container content">
			<div class="main__left">
					...
					<div class="container">
						...
						<form class="" method="post" action="/GlobalAdmins/create_update_query/update_query_devices.php">
							...
							<tr> 
								...
								<td><select class='select_db' name="Company">
										...
										$query = "SELECT * FROM `ManagementCompany` ORDER BY ManagementCompany.Name";
										$result_sel = mysqli_query($link, $query);
							...
							<div>
								...
								<tr>
									<td>
										...
										<?php 
            								echo "<a href='/GlobalAdmins/?table=Devices'>Отменить</a>";
            							?>
									</td>
								</tr>
								<?php
