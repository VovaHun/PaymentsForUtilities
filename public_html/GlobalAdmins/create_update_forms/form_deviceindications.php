		...
		<div class="container content">
			<div class="main__left">
					...
					<div class="container">
						...
						<form class="" method="post" action="/GlobalAdmins/create_update_query/update_query_deviceindications.php">
							...
							<?php 
								echo "<a href='/GlobalAdmins/?table=DeviceIndications'>Отменить</a>";
							  ?>
