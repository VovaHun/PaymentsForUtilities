<?php
    ...
    $query = "SELECT ManagementCompany.CompanyId, ManagementCompany.Name FROM ManagementCompany WHERE ManagementCompany.RegionId = $regionid GROUP BY ManagementCompany.CompanyId ORDER BY ManagementCompany.Name";
