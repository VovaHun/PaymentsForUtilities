		...
		<div class="container content">
			<div class="main__left">
					...
					<div class="container">
						...
						<form class = "" method = "post" action = "/GlobalAdmins/create_update_query/update_query_profit.php">
    									...
    									<tr> 
    										...
    										<td>
    										    <select class = 'select_db' name='company' required>
            										<?php       
                    									$query = "SELECT ManagementCompany.CompanyId, ManagementCompany.Name FROM ManagementCompany";
							...
							<div>
								...
								<tr>
									<td>
										...
										<?php 
            								echo "<a href='/GlobalAdmins/?table=Profit'>Отменить</a>";
            							?>
									</td>
								</tr>
							</table>
