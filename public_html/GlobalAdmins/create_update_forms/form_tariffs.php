		...
		<div class="container content">
			<div class="main__left">
					...
					<div class="container">
						...
						<form class="" method="post" action="/GlobalAdmins/create_update_query/update_query_tariffs.php">
 							...
 							<div class="form_wrapper">
								<table>
									...
									$query3 = "SELECT * FROM Regions ORDER BY Regions.RegionСode";
									$result3 = mysqli_query($link, $query3) or die("Ошибка " . mysqli_error($link));
									
									$query4 = "SELECT * FROM ManagementCompany ORDER BY ManagementCompany.Name";
							...
							<tr> 
								...
								<?php  
									if($res == -1){
										echo "<input type =text pattern='^[ 0-9]+(\.\d{2})?' placeholder='0.00' name=price value='' require>";
									}
									else{
										echo "<input type =text pattern='^[ 0-9]+(\.\d{2})?' placeholder='0.00' name=price value='".$row['Price']."' require>";
									}
							...
							<?php 
								echo "<a href='/GlobalAdmins/?table=Tariffs'>Отменить</a>";
							  ?>
