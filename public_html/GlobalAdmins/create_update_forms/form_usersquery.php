...
<body>
	<?php
		...
		$row = array( -1, '', '', '', 1, '', 0, '', 0, 1, '', '', 0, 0, 0, 0, date( 'd.m.Y H:i:s' ) );
            ...
            <div class="main__left">
				<div class="container">
					<div class="content__title">
						<h5>Запросы пользователей на регистрацию</h5>
					</div>
					<form class="" method="post" action="../create_update_query/update_query_usersquery.php">
						<input type="hidden" name="elem_id" value='<?php echo $id?>'>
							...
							<?php
								...
								echo "<table>";
									...
									echo "<tr>";
										...
										echo "<td><select name='BotId' id='BotId'>";
											echo "<option value='NULL'></option>";
											$query1 = "SELECT 
														   Bots.BotId AS BotId,
									...
									echo "<tr>";
										...
										echo "<td><input type=datetime name='QueryDate' id='QueryDate' value='" . $row[ 'QueryDate' ] . "' required></td>";
									echo "</tr>";
								echo "</table>";
							?>
						</div>
