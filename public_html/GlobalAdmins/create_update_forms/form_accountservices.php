		...
		<div class="container content">
			<div class="main__left">
					...
					<div class="container">
						...
						<form class="" method="post" action="/GlobalAdmins/create_update_query/update_query_accountservices.php">
								...
								<table>
									<?php
										...
										if ($accountId != -1){
											...
											echo "<tr>";
												echo "<td><label for='elem_6'>".$fn[6].":</label></td>";
												echo "<td><input type='text' pattern='^[ 0-9]+(\.\d{2})?' placeholder=' 0.00' id='elem_6' name='fn[6]' value=''></td>";
											echo "</tr>";

											echo "<tr>";
												echo "<td><label for='elem_7'>".$fn[7].":</label></td>";
												echo "<td><input type='text' pattern='^[ 0-9]+(\.\d{2})?' placeholder=' 0.00' id='elem_7' name='fn[7]' value=''></td>";
											echo "</tr>";
										}
									?>
								</table>
							...
							<a href="/GlobalAdmins/?table=AccountServices">Отменить</a>
						</form>
					</div>
			</div>
