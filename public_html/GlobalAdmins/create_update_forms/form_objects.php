		...
		<div class="container content">
			<div class="main__left">
					...
					<div class="container">
						...
						<form class="" method="post" action="/GlobalAdmins/create_update_query/update_query_objects.php">
							<input type="hidden" name="elem_id" value='<?php echo $res?>'>
							<div class="form_wrapper">
								<table>
									<?php
										$query1 ="SELECT ManagementCompany.CompanyId, ManagementCompany.Name FROM ManagementCompany ORDER BY ManagementCompany.Name";
										...
										if ($res != -1){
											...
											while($row0 = mysqli_fetch_array($result0)){
												...
												$query2 ="SELECT Objects.ObjectId, Objects.KadastrNo FROM Objects WHERE Objects.ObjectType = ".$parent_type." ORDER BY Objects.KadastrNo";
									    ...
									    echo "<tr>";
											...
											$query2 ="SELECT Objects.ObjectId, Objects.Name FROM Objects WHERE Objects.ObjectType = ".$parent_id;
											$result2 = mysqli_query($link, $query2) or die("Ошибка " . mysqli_error($link));
							...
							<div>
								...
								<tr>
									<td>
										...
										<a href='/GlobalAdmins/?table=Objects'>Отменить</a>
									</td>
								</tr>
								<?php
									if ( $res != -1 ) {
...
<script>
	$(document).ready(function(){
			...
			$('select.select_parent').on('change', function(){
                ...
                $.ajax({
                    method: "POST",
                    url: "/GlobalAdmins/object_query.php",
                    data: { ObjectType: val, Elem_id: id },
                    dataType: 'JSON'
                })
                .done(function( response ) {
                    $('select.select_child').empty();
                    $('select.select_child').prepend('<option disabled selected>Выберите объект</option>');
